...
|**Bot**<br/><ul><li>Notification (Function Hosted)</li></ul>|[tasks.json](https://github.com/OfficeDev/TeamsFx/blob/main/docs/vscode-extension/task-sample/bot/javascript/tasks.json)|[tasks.json](https://github.com/OfficeDev/TeamsFx/blob/main/docs/vscode-extension/task-sample/bot/typescript/tasks.json)|
