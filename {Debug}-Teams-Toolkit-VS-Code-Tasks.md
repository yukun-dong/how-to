...
> Note: these tasks are generated by Teams Toolkit (>= 4.0.7). To use these tasks in old Teams Toolkit project, see [Upgrade section](#upgrade-your-old-teams-toolkit-project-to-use-new-tasks).
