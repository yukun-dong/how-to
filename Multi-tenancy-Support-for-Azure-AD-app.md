...
2. Follow steps in [Action 1](https://github.com/OfficeDev/TeamsFx/blob/main/docs/fx-core/aad-help.md#action-1-note-frontend-info) and note your Frontend Domain.

3. (Optional) Follow steps in [Action 2](https://github.com/OfficeDev/TeamsFx/blob/main/docs/fx-core/aad-help.md#action-2-provision-cdn-profile-on-azure-portal) to provision CDN Profile on Azure Portal
...
4. Follow steps in [Action 3](https://github.com/OfficeDev/TeamsFx/blob/main/docs/fx-core/aad-help.md#action-3-update-frontend-info) to update the frontend info in your project.
